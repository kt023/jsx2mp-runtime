/*!
 * jsx2mp-runtime.bytedance.js v0.4.17
...
function getNativeComponentLifecycle (_ref) {
      ...
      _didUpdate = _ref.didUpdate;
  {
    ...
    return {
      ...
      detached: detached,
      observers: {
        outerProps: function outerProps(nextProps) {
          if (this.instance) {
            _didUpdate.call(this, this.instance.props.outerProps, nextProps);
          }
        }
      }
    };
...
function getId (type, internal) {
  switch (type) {
    case 'tag':
      if (internal["properties"]["__tagId"]) {
        return internal["properties"]["__tagId"];
      }
      return "t_" + _customId++;
    default:
      return "d_" + _customId++;
  ...
  return getNativeComponentLifecycle({
    ...
    didUpdate: function didUpdate(prevProps, nextProps) {
      if (this.instance && /^t_\d+$/.test(this.instance.instanceId) && this.data.$ready && !shallowEqual(prevProps, nextProps)) {
        this.instance.nextProps = Object.assign({}, this.instance.props, this["properties"]);
...
function generateBaseOptions(internal, defaultProps) {
  ...
  var props = Object.assign.apply(Object, [{}, defaultProps, internal["properties"], {
    "__tagId": instanceId,
    $slots: _extends({}, internal["properties"].$slots, internal["properties"].$scopedSlots)
